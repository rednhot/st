...
/* Spare fonts */
static char *font2[] = {
//    "JoyPixels:pixelsize=12:antialias=true:autohint=true", /* colored emoji in st don't work... */
...
#else
float alpha = 1.00, alphaUnfocused = 1.00;
#endif
...
#if defined(PRETTY_FLAG)
#include "/home/mathway/.cache/wal/colors-wal-st.h"
